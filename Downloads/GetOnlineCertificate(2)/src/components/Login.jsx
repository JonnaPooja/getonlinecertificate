...
//console.log(user.response.ok);
            ...
            this.props.history.push({pathname:'/userhome',state:{data:user.data.type}});
                }else{
    ...
    render(){
        ...
        return(
            ...
            + (?=.[a-z])(?=.[A-Z])
             ...
             <button style={{marginLeft: "10px"}} onClick={ () => this.ValidationForm()} className="btn btn-link">Signup </button>
             {loggingIn &&
